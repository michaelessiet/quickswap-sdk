...
<!-- [![npm version](https://badge.fury.io/js/simple-quickswap-sdk.svg)](https://badge.fury.io/js/simple-quickswap-sdk)
![downloads](https://img.shields.io/npm/dw/simple-quickswap-sdk) -->
...
```bash
$ npm install simple-quickswap-sdk
```

## yarn

```bash
$ yarn add simple-quickswap-sdk
```
...
```ts
import { QuickswapPair, ChainId, TradePath } from 'simple-quickswap-sdk';
...
```ts
import { QuickswapPair, ChainId } from 'simple-quickswap-sdk';
...
```ts
import { QuickswapPair, ChainId, TradeContext } from 'simple-quickswap-sdk';
...
```ts
import { QuickswapPair, WETH, TradePath, ChainId, TradeContext } from 'simple-quickswap-sdk';
...
```ts
import { QuickswapPair, WETH, ChainId, TradeContext, TradePath } from 'simple-quickswap-sdk';
...
```ts
import { TokenFactoryPublic, ChainId } from 'simple-quickswap-sdk';
...
```ts
import { TokensFactoryPublic, ChainId } from "simple-quickswap-sdk";
...
```ts
import { QuickswapContractFactoryPublic, ChainId } from "simple-quickswap-sdk";
...
https://github.com/michaelessiet/simple-quickswap-sdk
